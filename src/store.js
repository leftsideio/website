      ...
      synthwave: {
        ...
        actions: {
          async init(camera) {
            ...
            this.buildPalms()
            this.buildSky()
            set(state => void (state.synthwave.camera = camera))
          },
          async addSvgGraphics() {
            ...
            set(state => void (state.synthwave.svg = { sun, cityFar, cityClose }))
          },
          ...
          buildRoadLines() {
            ...
            set(
              state =>
                void (state.synthwave.geometry.roadLines = mergeBufferGeometries([
                  left,
                  right,
                  centerLeft,
                  centerRight,
          ...
          buildSidewalk() {
            ...
            set(
              state =>
                void (state.synthwave.geometry.sidewalk = mergeBufferGeometries([
                  topLeft,
                  sideLeft,
                  topRight,
                  sideRight,
    	...
    	` + shader.vertexShader
          ...
          buildPyramids() {
            ...
            set(state => void (state.synthwave.geometry.pyramids = pyramidGroups))
          },
          buildPalms() {
            ...
            set(state => void (state.synthwave.geometry.palms = palmTrees))
          },
          buildSky() {
            let radius = 12
            ...
            for (let i = 10; i < 20; i++) {
              ...
              stars.updateMatrix()
              pointsArray.push(stars)
            }
            set(state => void (state.synthwave.geometry.stars = pointsArray))
          },
        },
      },
    }
